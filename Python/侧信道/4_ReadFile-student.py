# -*- coding: utf-8 -*-
"""
Created on Fri Sep 24 10:40:10 2021
...
def Save2Npy(traces):
    ...
    numpy.save("pts.npy", numpy.array(pts))
    numpy.save("pcts.npy", numpy.array(pcts))
    numpy.save("pns.npy", numpy.array(pns))
    # 数据维数；补充
    print("Shape of pts:", numpy.array(pts).shape)
    print("Shape of pcts:", numpy.array(pcts).shape)
    print("Shape of pns:", numpy.array(pns).shape)
